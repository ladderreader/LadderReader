        ...
        return (
            <div id="labs" style={{ width: '100%', overflow: 'hidden' }}>
                ...
                <div className="label">
                    ...
                    { this.state.plugins.length > 5 && <a target="_blank" style={{ color:' #FF5252', borderBottom: '2px dotted', fontSize: '10px', fontWeight: 'bold' }}>过多的插件会使进入reading mode变慢，建议不要超过 6 个</a> }
                </div>
