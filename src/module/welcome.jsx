                    ...
                    <div className="carousel-item chrome" id="start">
                        ...
                        <img src={ ss.IconPath( "welcome" )} style={ style.img }/>
                            ...
                            <div style={ style.desc }>
                                { br.isFirefox() ? "Chrome 好评率超过 99% 的reading mode现已来到 Firefox" : "让你瞬间进入沉浸式阅读的 Chrome 扩展，类似 Safari 的reading mode" }<br/>
                                去掉干扰元素，提升阅读体验，<strong style={ style.strong }>「简」</strong>单阅读，愉<strong style={ style.strong }>「悦」</strong>心情<br/>
                                为了达到 <strong style={ style.strong }>「完美」</strong> 的reading mode，简悦适配了 <strong style={ style.strong }><a target="_blank" href="https://simpread.ksria.cn/sites/">数百种类型</a></strong> 的网站
                            </div>
                        </section>
                    </div>
                    ...
                    { first &&
                        <div className="carousel-item">
                            <section style={ style.section }>
                                ...
                                <h2 style={ style.h2 }>reading mode 与 focus mode</h2>
                                <div style={ style.desc }>
                                    reading mode → <strong>独有功能</strong>，自动提取适配页面的标题、描述、正文、媒体等资源<br/>
                                    支持 <a target="_blank" href="http://ksria.com/simpread/docs/#/手动框选">手动框选</a> · <a target="_blank" href="http://ksria.com/simpread/docs/#/主动适配reading mode">主动适配模式</a> · <a target="_blank" href="http://ksria.com/simpread/docs/#/词法分析引擎">智能适配模式</a>
                                    · <a target="_blank" href="http://ksria.com/simpread/docs/#/论坛类页面及分页">论坛类页面 / 分页</a><br/>
                                    <a target="_blank" href="http://ksria.com/simpread/docs/#/focus mode">focus mode</a> → 高亮鼠标所在的文章段落，不改变当前页面的结构<br/>
                                </div>
                            </section>
                        </div> }
                        ...
                        <div className="carousel-item" id="1.1.1">
                            <section style={ style.section }>
                                ...
                                <div style={ style.desc }>
                                    ...
                                    甚至，只要是结构良好的页面，（无需适配）自动生成reading mode，详细 <a target="_blank" href="http://ksria.com/simpread/docs/#/词法分析引擎">请看这里</a>
                                </div>
                            </section>
                        </div> }
