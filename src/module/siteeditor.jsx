            ...
            <dia.Dialog>
                ...
                <dia.Footer>
                    ...
                    { storage.pr.state == "temp" ?
                        <Button text="提交临时reading mode" waves="md-waves-effect" color="#fff" backgroundColor="#4CAF50" width="100%" onClick={ ()=>this.submit() } /> :
...
function Render() {
    switch ( true ) {
        case storage.pr.state == "meta":
            new Notify().Render( "当前为 <a href='http://ksria.com/simpread/docs/#/主动适配reading mode' target='_blank'>主动适配reading mode</a>，并不能使用设定功能。" )
            break;
