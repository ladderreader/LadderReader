    ...
    render() {
        return (
            <div id="labs" style={{ width: '100%' }}>
                ...
                <div className="label" data-head-level="h1">focus mode</div>
                <div style={{ 'padding-top': '10px' }} className="lab">
                ...
                <div className="label" data-head-level="h1">reading mode</div>
                <div style={{ 'padding-top': '10px' }} className="lab">
                    ...
                    <div ref="exclusion" style={{ 'padding-top': '10px', 'margin-bottom': '8px;' }}>
                        ...
                        <div className="sublabel">加入其中后将不会自动进入reading mode，仅当启用「自动进入reading mode」有效。</div>
                        <TextField 
                            multi={ true } rows={8}
                    ...
                    <div ref="whitelist" style={{ 'padding-top': '10px', 'margin-bottom': '8px;' }}>
                        ...
                        <div className="sublabel">加入其中后将自动进入reading mode，仅当禁用「自动进入reading mode」有效。</div>
                        <TextField 
                            multi={ true } rows={8}
                            placeholder="每行一个，支持： URL, minimatch 等。" 
                ...
                <div style={{ 'padding-top': '10px', 'position': 'relative' }} className="lab">
                    ...
                    <div className="sublabel">2. 关闭此功能后，只有进入reading mode时才会对页面进行解析，所以经常使用简悦的用户请勿关闭它。</div>
                    <div className="sublabel">3. 此功能的优先级比「自动进入reading mode」高；当关闭此功能时，自动进入reading mode将不会工作。</div>
                    </div>
