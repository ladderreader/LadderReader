	    ...
	    _createClass(Storage, [{
	        ...
	        value: function Safe(callback, data) {
	            ...
	            if (data) {
	                ...
	                if (_browser.br.isFirefox() && window.location.protocol != "moz-extension:") {
	                    callback && callback();
	                } else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function verify(callback) {
	    !_browser.br.isFirefox() ? _browser.browser.runtime.sendMessage(msg.Add(msg.MESSAGE_ACTION.save_verify, { url: window.location.href }), function (result) {
