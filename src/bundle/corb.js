...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _axios = __webpack_require__(855);
	    ...
	    if (request.type == msg.MESSAGE_ACTION.AXIOS) {
	        if (request.value.type == "post") {
	            if (request.value.form) {
	                ...
	                Object.keys(request.value.form).forEach(function (key) {
	                    return request.value.data.append(key, request.value.form[key]);
	                });
	            }
	            _axios2.default.post(request.value.url, request.value.data).then(function (response) {
	                return sendResponse({ done: response });
	            }).catch(function (error) {
	                return sendResponse({ fail: error });
	            });
	        } else if (request.value.type == 'put') {
	            _axios2.default.put(request.value.url, request.value.content, request.value.data).then(function (response) {
	                return sendResponse({ done: response });
	            }).catch(function (error) {
	                return sendResponse({ fail: error });
	            });
	        } else if (request.value.type == 'download') {
	            (0, _axios2.default)(request.value).then(function (response) {
	                return sendResponse({ done: response });
	            }).catch(function (error) {
	                return sendResponse({ fail: error });
	            });
	...
	_browser.browser.runtime.onMessage.addListener(function () {
	    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(request, sender, sendResponse) {
	        var option, url, protocol, dlRes, blob, _option, _url, upUrl, _blob;
	            ...
	            while (1) {
	                switch (_context.prev = _context.next) {
	                    case 0:
	                        ...
	                        _context.next = 7;
	                        return (0, _axios2.default)({ method: 'get', url: url.replace(/https?:/, protocol), responseType: 'blob' });
	                    ...
	                    case 19:
	                        if (!(request.type == msg.MESSAGE_ACTION.notion_up_img)) {
	                            _context.next = 31;
	                            break;
	                        }
	
	                        _context.prev = 20;
	                        _option = request.value, _url = _option.url, upUrl = _option.upUrl, _blob = downLoadCache.get(_url);
	                        _context.next = 24;
	                        return _axios2.default.put(upUrl, _blob, {
	                            headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(573), __webpack_require__(358)(module)))
