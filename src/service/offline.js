        ...
        html = `
                <html lang="en" class="simpread-font simpread-theme-root" style='${ $( "html" ).attr( "style" ) }'>
                    <head>
                        ...
                        <meta name="keywords" content="Chrome extension, Chrome 扩展, reading mode, 沉浸式阅读, 简悦, 简阅, read mode, reading mode, reader view, firefox, firefox addon, userscript, safari, opera, tampermonkey"/>
