...
const READ_MODE_GENERAL = "READ_MODE_GENERAL";
const READ_MODE_FAST = "READ_MODE_FAST";
const READ_MODE_DYSLEXIA_1 = "READ_MODE_DYSLEXIA_1";
const READ_MODE_DYSLEXIA_2 = "READ_MODE_DYSLEXIA_2";
const READ_MODE_DYSLEXIA_3 = "READ_MODE_DYSLEXIA_3";

const FONT_FAMILY_DEFAULT = "default";
const FONT_FAMILY_DYSLEXIC = "OpenDyslexic";

const EXPORT_TYPE_IMG = "EXPORT_TYPE_IMG";
const EXPORT_TYPE_PDF = "EXPORT_TYPE_PDF";
...
export {
    ...
    READ_MODE_GENERAL,
    READ_MODE_FAST,
    READ_MODE_DYSLEXIA_1,
    READ_MODE_DYSLEXIA_2,
    READ_MODE_DYSLEXIA_3,

    FONT_FAMILY_DEFAULT,
    FONT_FAMILY_DYSLEXIC,
